...
class ConversationRouter(BaseRouter):
    def __init__(
        self,
        agent_thunk: Callable[[Optional[str]], BaseAgent],
    ...
    def get_conversation(
        ...
        situation = None
        if start_message.meta_data is not None:
            situation = start_message.meta_data.get("situation")
        agent = self.agent_thunk(situation)
